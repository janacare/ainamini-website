...
$(document).ready(function () {
    ...
    $("#contactForm").submit(function(e){
        ...
        $.ajax(
            {
                url : "https://www.habitsprogram.com/dmanager/contactUsMail",
                type: "POST",
                data : JSON.stringify({
                	"name":$("#name").val(),
					"email":$("#email").val(),
                ...
                {
                    console.log(data);
                    $cfResponse.html("Thank you for contacting us. We will get in touch with you shortly.");
                    $("#name").val("");
                    $("#company").val("");
                    $("#email").val("");
                    $("#message").val("");
...
(function(){
	...
	function fadeIntro(scrollTopp) {
		...
		if ((homeSection.length > 0) && ($(window).width() > 479)){
...
$("#playVideo").click(function(e){
    ...
    document.getElementById('vimeo').src = "https://player.vimeo.com/video/126044483?autoplay=1";
    $("#video").hide();
